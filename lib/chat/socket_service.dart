...
class SocketService {
  ...
  bool _isConnecting =
      false; // Prevent multiple simultaneous connection attempts
    ...
    try {
      ...
      try {
        if (_isConnected && _socket.connected) {
          print('[SocketService] Disconnecting old socket...');
          _socket.disconnect();
          await Future.delayed(const Duration(milliseconds: 500));
        }
      } catch (e) {
        print('[SocketService] Note: No previous socket to disconnect');
      }
  ...
  void _setupEventHandlers() {
    ...
    _socket.onDisconnect((_) {
      try {
        ...
        print('[SocketService] Note: Disconnect callback error (safe): $e');
      }
    });
  ...
  void disconnect() {
    try {
      ...
      print('[SocketService] Error during disconnect: $e');
    }
  }
