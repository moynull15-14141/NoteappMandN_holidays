...
import 'package:noteapp/data/services/speech_service.dart';
...
class _DiaryEntryScreenState extends ConsumerState<DiaryEntryScreen> {
  ...
  Future<void> _initializeSpeech() async {
    try {
      final isAvailable = await _speechService.initializeSpeech();
      if (mounted && isAvailable) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Voice recording ready'),
  ...
  Future<void> _toggleVoiceRecording() async {
    if (_isListening) {
      ...
      final result = _speechService.getLastResult();
